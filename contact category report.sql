...
detail AS (
    SELECT 
        ...
        CASE WHEN duration_category = 'Red' THEN 1 END AS red_count,
        CASE WHEN duration_category = 'Green' THEN 1 END AS green_count,
        CASE WHEN duration_category = 'Amber' THEN 1 END AS amber_count,
        avg_duration,
